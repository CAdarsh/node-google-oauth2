...
export declare namespace documentai_v1 {
    ...
    export class Resource$Projects$Locations$Operations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancelOperation(params: Params$Resource$Projects$Locations$Operations$Canceloperation, options: StreamMethodOptions): GaxiosPromise<Readable>;
        cancelOperation(params?: Params$Resource$Projects$Locations$Operations$Canceloperation, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
        cancelOperation(params: Params$Resource$Projects$Locations$Operations$Canceloperation, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        cancelOperation(params: Params$Resource$Projects$Locations$Operations$Canceloperation, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        cancelOperation(params: Params$Resource$Projects$Locations$Operations$Canceloperation, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        cancelOperation(callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Operations$Canceloperation extends StandardParameters {
        /**
         * The name of the operation resource to be cancelled.
         */
        name?: string;
    ...
    export class Resource$Uiv1beta3$Projects$Locations$Operations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancelOperation(params: Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation, options: StreamMethodOptions): GaxiosPromise<Readable>;
        cancelOperation(params?: Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
        cancelOperation(params: Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        cancelOperation(params: Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        cancelOperation(params: Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        cancelOperation(callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        /**
         * Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
         * @example
    ...
    export interface Params$Resource$Uiv1beta3$Projects$Locations$Operations$Canceloperation extends StandardParameters {
        /**
         * The name of the operation resource to be cancelled.
         */
        name?: string;
